...
public class RoomCall13 : MonoBehaviour {
	...
	private string roomTypeValue13;
	
	// Use this for initialization
	public void GetMatrix13Value()
	{
		UpdatedGenerator matrixValue13 = GameObject.Find ("Dungeon Generator").GetComponent<UpdatedGenerator>();
		roomTypeValue13 = (matrixValue13.mapMatrix[7]);
	...
	void AssignRoomType (string roomType) 
	{
		...
		case "A":
			...
			roomAGet.startingPositionA = new Vector3(30.0f, -8.0f, 0.0f);
			roomAGet.roomValue = roomType;
			roomAGet.BeginRoom();
			//Debug.Log ("This needs to be an A room in 13.");
			break;
		case "B":
			//Find the RoomB script
			RoomB roomBGet = GameObject.Find("Matrix00").GetComponent<RoomB>();
			roomBGet.startingPositionB = new Vector3(30.0f, -8.0f, 0.0f);
			roomBGet.roomValue = roomType;
			roomBGet.BeginRoom();
			//Debug.Log ("This needs to be an B room in 13.");
			break;
		case "C":
			//Find the RoomC script
			RoomC roomCGet = GameObject.Find("Matrix00").GetComponent<RoomC>();
			roomCGet.startingPositionC = new Vector3(30.0f, -8.0f, 0.0f);
			roomCGet.roomValue = roomType;
			roomCGet.BeginRoom();
			//Debug.Log ("This needs to be an C room in 13.");
			break;
		case "D":
			//Find the RoomD script
			RoomD roomDGet = GameObject.Find("Matrix00").GetComponent<RoomD>();
			roomDGet.startingPositionD = new Vector3(30.0f, -8.0f, 0.0f);
			roomDGet.roomValue = roomType;
			roomDGet.BeginRoom();
			//Debug.Log ("This needs to be an D room in 13.");
			break;
		case "E":
			...
			roomEGet.BeginRoom();
			//Debug.Log ("This needs to be an E room in 13.");			
			break;
		case "F":
			//Find the RoomF script
			RoomF roomFGet = GameObject.Find("Matrix00").GetComponent<RoomF>();
			roomFGet.startingPositionF = new Vector3(30.0f, -8.0f, 0.0f);
			roomFGet.roomValue = roomType;
			roomFGet.BeginRoom();
			//Debug.Log ("This needs to be an F room in 13.");
			break;
		case "G":
			//Find the RoomG script
			RoomG roomGGet = GameObject.Find("Matrix00").GetComponent<RoomG>();
			roomGGet.startingPositionG = new Vector3(30.0f, -8.0f, 0.0f);
			roomGGet.roomValue = roomType;
			roomGGet.BeginRoom();
			//Debug.Log ("This needs to be an G room in 13.");
			break;
		case "H":
			//Find the RoomH script
			RoomH roomHGet = GameObject.Find("Matrix00").GetComponent<RoomH>();
			roomHGet.startingPositionH = new Vector3(30.0f, -8.0f, 0.0f);
			roomHGet.roomValue = roomType;
			roomHGet.BeginRoom();
			//Debug.Log ("This needs to be an H room in 13.");
			break;
		case "O":
			//Find the RoomO script
			RoomO roomOGet = GameObject.Find("Matrix00").GetComponent<RoomO>();
			roomOGet.startingPositionO = new Vector3(30.0f, -8.0f, 0.0f);
			roomOGet.roomValue = roomType;
			roomOGet.BeginRoom();
			//Debug.Log ("This needs to be an O room in 13.");
			break;
		default:
