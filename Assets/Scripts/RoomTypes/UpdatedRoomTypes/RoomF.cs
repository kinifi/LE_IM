...
public class RoomF : MonoBehaviour {
	
	//Configs set from Room Call
	private GameObject[] tileOfRoom;
	public Vector3 startingPositionF;
	...
	private void AssignRoomArray ()
	{
		...
		default:
			...
			Debug.Log("Something went wrong when selecting RoomPart2 for in RoomF");
			break;
		}
		/*
			roomArray = new int[] 
