...
class SteamStatsAndAchievements : MonoBehaviour {
	...
	private Achievement_t[] m_Achievements = new Achievement_t[] {
		...
		new Achievement_t(Achievement.Halfway_There, "Complete 50% of the Challenge Levels", ""),
	...
	public int m_nTotalNumBossesDefeated;
	...
	private void Update() {
		...
		///Check to see if the fall over 15 times stat needs to unlock an achievement
		foreach (Achievement_t achievement in m_Achievements) {
			...
			case Achievement.Tysjacha:
				if (m_nTotalNumDeathByFalling >= 15) {
		...
		///Check to see if the number of trampolines achievement should be unlocked
		foreach (Achievement_t achievement in m_Achievements) {
			if (achievement.m_bAchieved)
				continue;
		...
		if (m_bStoreStats) {
			...
			SteamUserStats.SetStat("NumBossesDefeated", m_nTotalNumBossesDefeated);
	...
	/// </summary>
	public void Unlock_Nice_Game_Developers_Achievement()
	{
		SteamUserStats.SetAchievement("Nice_Game_Developers");
		m_bStoreStats = true;
	}
	
	/// <summary>
	/// Unlock_s the Check the Memory Book Achievement
	/// </summary>
	public void Unlock_Check_the_Memory_Book()
	{
		SteamUserStats.SetAchievement("Check_the_Memory_Book");
		m_bStoreStats = true;
	}
	
	/// <summary>
	/// Unlock_s the full Tank Achievement
	/// </summary>
	public void Unlock_Full_Tank_Achievement()
	{
		SteamUserStats.SetAchievement("Full_Tank");
		m_bStoreStats = true;
	}
	
	/// <summary>
	/// Unlock_s the Halfway There Achievement
	/// </summary>
	public void Unlock_Halfway_There_Achievement()
	{
		SteamUserStats.SetAchievement("Halfway_There");
	...
	public void getStats() {
		...
		SteamUserStats.GetStat("NumBossesDefeated", out m_nTotalNumBossesDefeated);
		...
		Debug.Log("NumBossesDefeated: " + m_nTotalNumBossesDefeated);
	}
