...
public class WolfBossFakeParticles : MonoBehaviour {
	...
	private void BreathA ()
	{
		...
		//PARTICLE DEATHS!!!!!
		randomDeathRate = Random.Range (1.0f, 3.0f);
	...
	private void BreathB ()
	{
		...
		//PARTICLE DEATHS!!!!!
		randomDeathRateB = Random.Range (1.5f, 3.0f);
	...
	private void BreathC ()
	{
		...
		//PARTICLE DEATHS!!!!!
		randomDeathRateC = Random.Range (0.5f, 3.0f);
	...
	private void BreathD ()
	{
		...
		//PARTICLE DEATHS!!!!!
		randomDeathRateD = Random.Range (0.5f, 2.0f);
	...
	private void BreathE ()
	{
		...
		//PARTICLE DEATHS!!!!!
		randomDeathRateE = Random.Range (0.5f, 3.5f);
	...
	private void BreathF ()
	{
		...
		//PARTICLE DEATHS!!!!!
		randomDeathRateF = Random.Range (2.0f, 3.0f);
